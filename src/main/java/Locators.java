...
public class Locators {
    ...
    public static final By BIRTH_DATE_DROPDOWNLIST_DAY_SELECT = By.xpath("//ul[@class='dropdown-menu']//a[@data-value='16']");
    public static final By BIRTH_DATE_DROPDOWNLIST_MONTH = By.xpath("//div[@id='monthSelect']");
    public static final By BIRTH_DATE_DROPDOWNLIST_DAY_MONTH_SELECT = By.xpath("//ul[@class='dropdown-menu']//a[@data-value='4'][text()='May']");
    public static final By BIRTH_DATE_DROPDOWNLIST_YEAR = By.xpath("//div[@id='yearSelect']");
    public static final By BIRTH_DATE_DROPDOWNLIST_YEAR_SELECT = By.xpath("//ul[@class='dropdown-menu']//a[@data-value='1942']");
